...
public class Car extends Auto {
    ...
    public Car(String firma, int speed, String gosNomer, String name, int n, Boolean f){
        super(firma,speed,gosNomer); //вызываем конструктор класса-родителя с параметрами (см. класс Auto)
